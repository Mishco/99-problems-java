...
==== link:/src/main/java/logiccodes/P46.java[P46 - Truth tables for logical expressions (2).]
==== link:/src/main/java/logiccodes/P47.java[P42 - Truth tables for logical expressions (3).]
==== P43 - Gray code.
==== P44 - Huffman code.
