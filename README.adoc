...
==== link:/src/main/java/lists/P36.java[P36 - Calculate Euler's totient function phi(m).]
==== link:/src/main/java/lists/P37.java[P37 - Calculate Euler's totient function phi(m) (2).]
==== link:/src/main/java/lists/P38.java[P38 - Compare the two methods of calculating Euler's totient function.]
